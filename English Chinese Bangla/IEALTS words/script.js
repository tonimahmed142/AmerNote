...
async function loadWords() {
    englishWords = await fetchWords('iealtsenglish.txt');
    chineseWords = await fetchWords('iealtschinese.txt');
    pinyinWords = await fetchWords('iealtspinyin.txt');
    banglaWords = await fetchWords('iealtsbangla.txt');
