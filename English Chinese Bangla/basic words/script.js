...
async function loadWords() {
    englishWords = await fetchWords('basicenglish.txt');
    chineseWords = await fetchWords('basicchinese.txt');
    pinyinWords = await fetchWords('basicpinyin.txt');
    banglaWords = await fetchWords('basicbangla.txt');
